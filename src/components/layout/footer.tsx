  ...
  return (
    <footer className="bg-transparent pt-12 pb-12 px-6 md:px-12 relative overflow-hidden">
      <div className="container mx-auto">
        ...
        <div className="bg-white/20 rounded-[2rem] p-8 mb-8 text-center text-dark-900 max-w-7xl mx-auto backdrop-blur-md shadow-xl">
          <h2 className="text-[42px] font-medium mb-4 tracking-tight">Regulatory & Compliance Disclosure</h2>
          <p className="text-lg max-w-4xl mx-auto leading-tight tracking-tight">
        ...
        <div className="bg-white/20 rounded-[2.5rem] p-10 max-w-7xl mx-auto backdrop-blur-xl shadow-2xl text-white">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-12">
            ...
            <div className="lg:col-span-4">
              ...
              <div className="text-sm tracking-tight space-y-4">
                <div>
            ...
            <div className="lg:col-span-2">
              ...
              <ul className="text-sm tracking-tight space-y-2 font-normal">
            ...
            <div className="lg:col-span-2">
              ...
              <ul className="text-sm tracking-tight space-y-2 mb-6 font-normal">
                <li className="flex items-center gap-2"><span>📞</span> +91 0000000000</li>
                <li className="flex items-center gap-2"><span>✉️</span> info@ibsfincorp.com</li>
                <li className="flex items-center gap-2"><span>📍</span> Chennai, Tamil Nadu</li>
              </ul>
          ...
          <div className="border-t border-white/30 pt-4 flex flex-col md:flex-row justify-between items-center text-sm font-normal tracking-tight">
          ...
          <div className="border-t border-white/30 mt-4">
            ...
            <p className="text-sm mt-8 text-left max-w-6xl leading-tight tracking-tight font-normal">
