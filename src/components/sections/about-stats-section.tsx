    ...
    <section id="about" className="py-24 bg-white text-dark-900">
      <div className="container mx-auto px-6 md:px-12">
        ...
        <div className="text-center max-w-4xl mx-auto mb-20">
          <div className="inline-flex items-center gap-2 border border-gray-200 rounded-full px-4 py-1 mb-8 text-base font-medium tracking-tighter">
          ...
          <TextBlurReveal
            ...
            className="text-3xl md:text-5xl font-medium leading-tighter tracking-tighter"
          />
        </div>
